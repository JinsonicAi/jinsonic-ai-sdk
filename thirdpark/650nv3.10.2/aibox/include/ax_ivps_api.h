...
#define AX_IVPS_REGION_MAX_DISP_NUM (32)
    ...
    */
    ...
    AX_S32 AX_IVPS_AlphaBlendingV3Vgp(const AX_VIDEO_FRAME_T *ptSrc, const AX_OVERLAY_T *ptOverlay,
                                      AX_VIDEO_FRAME_T *ptDst);
    AX_S32 AX_IVPS_AlphaBlendingAsyncTdp(const AX_VIDEO_FRAME_T *ptSrc, const AX_VIDEO_FRAME_T *ptOverlay,
                                      const AX_IVPS_POINT_T tOffset, AX_U8 nAlpha, AX_VIDEO_FRAME_T *ptDst);
    ...
    /*****************************************************************************
    *   Prototype    : AX_IVPS_LDCH_MeshGen()
    *   Description  : This API is used to generate mesh table from dst to src for LDCH.
    *   Parameters   : ptMapUserAttr    The attribute of mesh table.
    *                  ptLdcHAttr       The attribute of LDCH.
    *   Return Value : 0: Success; Error codes: Failure.
    *   Spec         :
    *****************************************************************************/
    AX_S32 AX_IVPS_LDCH_MeshGen(AX_IVPS_MAP_USER_ATTR_T *ptMapUserAttr, const AX_IVPS_LDCH_ATTR_T *ptLdcHAttr);

    /*****************************************************************************
    *   Prototype    : AX_IVPS_LDCH_PointQueryDst2Src()
    *   Description  : This API is used to find a point of the source image according to a point of destination image.
    *   Parameters   : ptDst    The coordinate point of destination map, [0, width].
    *                  ptSrc    The coordinate point of source map, [0, height].
    *                  ptLdcHAttr    The attribute of LDCH.
    *   Return Value : 0: Success; Error codes: Failure.
    *   Spec         :
    *****************************************************************************/
    AX_S32 AX_IVPS_LDCH_PointQueryDst2Src(const AX_IVPS_POINT_NICE_T *ptDst, AX_IVPS_POINT_NICE_T *ptSrc, const AX_IVPS_LDCH_ATTR_T *ptLdcHAttr);
